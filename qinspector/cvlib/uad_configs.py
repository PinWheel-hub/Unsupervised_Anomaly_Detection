...
class ConfigParser(object):
    ...
    def __init__(self, args, if_print: bool = True):
    ...
    def parser(self):
        self.cfg['save_path'] = ''.join(self.cfg['save_path'])
        self.cfg['model_path'] = ''.join(self.cfg['model_path'])
        self.cfg['result_path'] = ''.join(self.cfg['result_path'])
